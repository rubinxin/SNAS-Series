...
# set name of job
#SBATCH --job-name=emasotlnorcdarts1
#SBATCH --output=emasotlnorcdarts1.out
...
--temp_min 0.03 --nsample 1 --temp_annealing --gen_max_child --alter_metric  "ema_sotl" \
--resource_lambda 1.5e-3 --log_penalty --drop_path_prob 3e-1 --method 'reparametrization' \
--loss --remark "snas_emasotl_darts_norc_layer_8_batch_64_drop_0.3_error_lnR_1e-2_reparam_gpu_1"
