...
# set name of job
#SBATCH --job-name=dsemasotldarts2
#SBATCH --output=dsemasotldarts2.out
...
--loss --remark "dsnas_emasotl_darts_layer_8_batch_64_drop_0.3_error_lnR_1e-2_reparam_gpu_1"
