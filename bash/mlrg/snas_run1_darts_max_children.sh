...
# set name of job
#SBATCH --job-name=snasdarts2
#SBATCH --output=snasdarts2.out
...
--temp_min 0.03 --nsample 1 --temp_annealing --resource_efficient --gen_max_child \
--resource_lambda 1.5e-3 --log_penalty --drop_path_prob 3e-1 --method 'reparametrization' \
--loss --remark "snas_darts_layer_8_batch_64_drop_0.3_error_lnR_1e-2_reparam_gpu_2"
